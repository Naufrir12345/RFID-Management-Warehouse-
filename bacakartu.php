<?php
   ...
   // $baca_kartu = mysqli_query($conn, "select * from rfid_data");
    ...
    //baca kartu dari tabel rfid_data
    $baca_kartu = mysqli_query($conn, "SELECT * FROM rfid_data");
    $data_kartu = mysqli_fetch_array($baca_kartu);
...
<div class="container-fluid" style="text-align: center";>
   ...
   <?php } else {
        ...
        // $cari_data = mysqli_query($conn, "SELECT * FROM view_registrasi where uid='$uid'");
        ...
        //     $cari_barang = mysqli_query($conn, "SELECT * from registrasi where uid='$uid'");
